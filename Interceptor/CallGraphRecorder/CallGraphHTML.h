...
#ifdef USING_WSTRING
	const static STD_STRING html_data_key = L"$CALL_GRAPH_DATA$";
	const static STD_STRING html = LR"(<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN">
<html lang="en">
	<head>
		<meta charset="utf-8">
...
#else
	const static STD_STRING html_data_key = "$CALL_GRAPH_DATA$";
	const static STD_STRING html = R"(<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN">
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Force based label placement</title>
